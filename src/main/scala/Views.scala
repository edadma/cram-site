										...
										<table class="table table-hover" style="width: 100%">
											...
											<tr ng-repeat="pair in lessonData.pairs">
												<td ng-click="editFront($index)">
													...
													<form name="frontForm" ng-show="editingFront == $index" ng-submit="updateFront($index)" ng-controller="LessonEditFormController">
												...
												<td ng-click="editBack($index)">
													...
													<form name="backForm" ng-show="editingBack == $index" ng-submit="updateBack($index)" ng-controller="LessonEditFormController">
